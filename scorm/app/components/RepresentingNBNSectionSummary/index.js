...
const RepresentingNBNSectionSummary = View.extend({
  className: 'RepresentingNBNSectionSummary',
  ...
  events: {
    'click .RepresentingNBNSectionSummary__continueButton': 'handleContinueButtonClick',
  },
...
export default mixin(RepresentingNBNSectionSummary, PropsStateMixin, ContentPanelMixin, MiniDashboardContainerMixin);
